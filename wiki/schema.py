...
WORK_KIND_GROUP = {
    ...
    "珐琅": "器物",
    # 「拓片」是清点国内馆藏时补入的，而它本该早就有：本库有 `rubbing` 块，
    # README 也明写「碑刻的研究对象常是拓本而非原石」「研习书法该看早拓，不是看原石」
    # ——**主张摆在那里，而承载它的 kind 一直缺**。
    # 拓片与碑刻是两件物：碑是石，拓片是那块石在某一时刻的一份记录，
    # 早拓与近拓所记的字口已经不同。归石刻组，那一组的维度（拓本谱系、字口存损、
    # 著录与考订）正是为它设的。
    "碑刻": "石刻", "摩崖": "石刻", "画像石": "石刻", "经幢": "石刻", "拓片": "石刻",
    "壁画": "窟寺", "塑像": "窟寺",
